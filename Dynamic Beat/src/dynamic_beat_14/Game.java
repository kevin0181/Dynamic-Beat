...
public class Game extends Thread {
	...
	public void dropNotes() {
		Beat[] beats = null;
		if (titleName.equals("We Are One - Vexento")) {
			int startTime = 4460 - Main.REACH_TIME * 1000;
			int gap = 125;
			beats = new Beat[] { new Beat(startTime + gap * 2, "S"), new Beat(startTime + gap * 4, "S"),
					new Beat(startTime + gap * 6, "S"), new Beat(startTime + gap * 8, "S"),
					...
					new Beat(startTime + gap * 52, "K"), new Beat(startTime + gap * 52, "D"), };
		} else if (titleName.equals("Epiphany - MusicbyAden")) {
			int startTime = 1000;
			beats = new Beat[] { new Beat(startTime, "Space"), };
		} else if (titleName.equals("Adventures - A Himitsu")) {
			int startTime = 1000;
			beats = new Beat[] { new Beat(startTime, "Space"), };
		}
		int i = 0;
