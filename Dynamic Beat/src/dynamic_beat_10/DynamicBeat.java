...
public class DynamicBeat extends JFrame {
	...
	private Image judgmentLineImage = new ImageIcon(Main.class.getResource("../images/judgementLine.png")).getImage(); // 게임
																														// 판정
																														// 바
	private Image noteRouteImage = new ImageIcon(Main.class.getResource("../images/noteRoute.png")).getImage(); // 게임 판정
																												// 바
	private Image noteRouteLineImage = new ImageIcon(Main.class.getResource("../images/noteRouteLine.png")).getImage(); // 게임
																														// 판정
																														// 바
	...
	public void screenDraw(Graphics2D g) {
		...
		if (isGameScreen) {
			...
			g.drawString("We Are One - Vexento", 20, 702);
